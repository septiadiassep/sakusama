            ...
            <td>
              <ul class="list-unstyled m-0 avatar-group d-flex align-items-center">
                <li
                  ...
                  title="Lilian Fuller">
                  <img src="{{ asset('sneat-v3.0.0') }}/assets/img/avatars/2.png" alt="Avatar" class="rounded-circle" />
                </li>
                <li
                  data-bs-toggle="tooltip"
                  data-popup="tooltip-custom"
                  ...
                  <img src="{{ asset('sneat-v3.0.0') }}/assets/img/avatars/3.png" alt="Avatar" class="rounded-circle" />
                </li>
                <li
                  data-bs-toggle="tooltip"
                  data-popup="tooltip-custom"
                  ...
                  <img src="{{ asset('sneat-v3.0.0') }}/assets/img/avatars/4.png" alt="Avatar" class="rounded-circle" />
                </li>
              </ul>
            </td>
